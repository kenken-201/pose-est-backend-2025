...
def test_process_video_use_case_wiring(container: AppContainer) -> None:
    ...
    with (
        patch("posture_estimation.infrastructure.ml.movenet_estimator.hub.load"),
        patch(
            "posture_estimation.infrastructure.ml.movenet_estimator.MoveNetPoseEstimator._warmup"
        ),
